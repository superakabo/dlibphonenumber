...
void main() {
  group('PhoneNumberUtilTest', () {
    ...
    test('testGetInstanceLoadUSMetadata', () {
      ...
      expect(metadata.generalDesc.nationalNumberPattern, '[13-689]\\d{9}|2[0-35-9]\\d{8}');
      expect(metadata.fixedLine.nationalNumberPattern, '[13-689]\\d{9}|2[0-35-9]\\d{8}');
    ...
    test('testGetInstanceLoadDEMetadata', () {
      ...
      expect(metadata.fixedLine.nationalNumberPattern, '(?:[24-6]\\d{2}|3[03-9]\\d|[789](?:0[2-9]|[1-9]\\d))\\d{1,8}');
      expect(metadata.fixedLine.exampleNumber, '30123456');
      expect(metadata.premiumRate.nationalNumberPattern, '900([135]\\d{6}|9\\d{7})');
    });
    ...
    test('testGetInstanceLoadARMetadata', () {
      ...
      expect(metadata.intlNumberFormat[3].pattern, '(\\d)(\\d{4})(\\d{2})(\\d{4})');
    ...
    test('testGetLengthOfGeographicalAreaCode', () {
      ...
      expect(phoneUtil.getLengthOfGeographicalAreaCode(_internationalTollFree), 0);
    });
    ...
    test('testGetLengthOfNationalDestinationCode', () {
      ...
      expect(phoneUtil.getLengthOfNationalDestinationCode(_usShortByOneNumber), 0);
      ...
      expect(phoneUtil.getLengthOfNationalDestinationCode(_internationalTollFree), 4);
    });
    ...
    test('testGetNationalSignificantNumber', () {
      ...
      expect(phoneUtil.getNationalSignificantNumber(_internationalTollFree), '12345678');
    ...
    test('testFormatUSNumber', () {
      expect(phoneUtil.format(_usNumber, PhoneNumberFormat.national), '650 253 0000');
      expect(phoneUtil.format(_usNumber, PhoneNumberFormat.international), '+1 650 253 0000');

      expect(phoneUtil.format(_usTollfree, PhoneNumberFormat.national), '800 253 0000');
      expect(phoneUtil.format(_usTollfree, PhoneNumberFormat.international), '+1 800 253 0000');

      expect(phoneUtil.format(_usPremium, PhoneNumberFormat.national), '900 253 0000');
      expect(phoneUtil.format(_usPremium, PhoneNumberFormat.international), '+1 900 253 0000');
      expect(phoneUtil.format(_usPremium, PhoneNumberFormat.rfc3966), 'tel:+1-900-253-0000');
      ...
      // specified.
      expect(phoneUtil.format(_usSpoofWithRawInput, PhoneNumberFormat.national), '000-000-0000');
      expect(phoneUtil.format(_usSpoof, PhoneNumberFormat.national), '0');
    });

    test('testFormatBSNumber', () {
      expect(phoneUtil.format(_bsNumber, PhoneNumberFormat.national), '242 365 1234');
      expect(phoneUtil.format(_bsNumber, PhoneNumberFormat.international), '+1 242 365 1234');
    });

    test('testFormatGBNumber', () {
      expect(phoneUtil.format(_gbNumber, PhoneNumberFormat.national), '(020) 7031 3000');
      expect(phoneUtil.format(_gbNumber, PhoneNumberFormat.international), '+44 20 7031 3000');

      expect(phoneUtil.format(_gbMobile, PhoneNumberFormat.national), '(07912) 345 678');
      expect(phoneUtil.format(_gbMobile, PhoneNumberFormat.international), '+44 7912 345 678');
    });
    ...
    test('testFormatDENumber', () {
      ...
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '030/1234');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.international), '+49 30/1234');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.rfc3966), 'tel:+49-30-1234');

      deNumber = PhoneNumber()
        ..countryCode = 49
        ..nationalNumber = Int64(291123);
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '0291 123');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.international), '+49 291 123');

      deNumber = PhoneNumber()
        ..countryCode = 49
        ..nationalNumber = Int64(29112345678);
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '0291 12345678');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.international), '+49 291 12345678');

      deNumber = PhoneNumber()
        ..countryCode = 49
        ..nationalNumber = Int64(912312345);
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '09123 12345');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.international), '+49 9123 12345');

      deNumber = PhoneNumber()
        ..countryCode = 49
        ..nationalNumber = Int64(80212345);
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '08021 2345');
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.international), '+49 8021 2345');
      ...
      expect(phoneUtil.format(_deShortNumber, PhoneNumberFormat.national), '1234');
      expect(phoneUtil.format(_deShortNumber, PhoneNumberFormat.international), '+49 1234');

      deNumber = PhoneNumber()
        ..countryCode = 49
        ..nationalNumber = Int64(41341234);
      expect(phoneUtil.format(deNumber, PhoneNumberFormat.national), '04134 1234');
    });

    test('testFormatITNumber', () {
      expect(phoneUtil.format(_itNumber, PhoneNumberFormat.national), '02 3661 8300');
      expect(phoneUtil.format(_itNumber, PhoneNumberFormat.international), '+39 02 3661 8300');
      expect(phoneUtil.format(_itNumber, PhoneNumberFormat.e164), '+390236618300');

      expect(phoneUtil.format(_itMobile, PhoneNumberFormat.national), '345 678 901');
      expect(phoneUtil.format(_itMobile, PhoneNumberFormat.international), '+39 345 678 901');
      expect(phoneUtil.format(_itMobile, PhoneNumberFormat.e164), '+39345678901');
    });

    test('testFormatAUNumber', () {
      expect(phoneUtil.format(_auNumber, PhoneNumberFormat.national), '02 3661 8300');
      expect(phoneUtil.format(_auNumber, PhoneNumberFormat.international), '+61 2 3661 8300');
      expect(phoneUtil.format(_auNumber, PhoneNumberFormat.e164), '+61236618300');

      final auNumber = PhoneNumber()
        ..countryCode = 61
        ..nationalNumber = Int64(1800123456);
      expect(phoneUtil.format(auNumber, PhoneNumberFormat.national), '1800 123 456');
      expect(phoneUtil.format(auNumber, PhoneNumberFormat.international), '+61 1800 123 456');
      expect(phoneUtil.format(auNumber, PhoneNumberFormat.e164), '+611800123456');
    });

    test('testFormatARNumber', () {
      expect(phoneUtil.format(_arNumber, PhoneNumberFormat.national), '011 8765-4321');
      expect(phoneUtil.format(_arNumber, PhoneNumberFormat.international), '+54 11 8765-4321');
      expect(phoneUtil.format(_arNumber, PhoneNumberFormat.e164), '+541187654321');

      expect(phoneUtil.format(_arMobile, PhoneNumberFormat.national), '011 15 8765-4321');
      expect(phoneUtil.format(_arMobile, PhoneNumberFormat.international), '+54 9 11 8765 4321');
      expect(phoneUtil.format(_arMobile, PhoneNumberFormat.e164), '+5491187654321');
    });

    test('testFormatMXNumber', () {
      expect(phoneUtil.format(_mxMobile1, PhoneNumberFormat.national), '045 234 567 8900');
      expect(phoneUtil.format(_mxMobile1, PhoneNumberFormat.international), '+52 1 234 567 8900');
      expect(phoneUtil.format(_mxMobile1, PhoneNumberFormat.e164), '+5212345678900');

      expect(phoneUtil.format(_mxMobile2, PhoneNumberFormat.national), '045 55 1234 5678');
      expect(phoneUtil.format(_mxMobile2, PhoneNumberFormat.international), '+52 1 55 1234 5678');
      expect(phoneUtil.format(_mxMobile2, PhoneNumberFormat.e164), '+5215512345678');

      expect(phoneUtil.format(_mxNumber1, PhoneNumberFormat.national), '01 33 1234 5678');
      expect(phoneUtil.format(_mxNumber1, PhoneNumberFormat.international), '+52 33 1234 5678');
      expect(phoneUtil.format(_mxNumber1, PhoneNumberFormat.e164), '+523312345678');

      expect(phoneUtil.format(_mxNumber2, PhoneNumberFormat.national), '01 821 123 4567');
      expect(phoneUtil.format(_mxNumber2, PhoneNumberFormat.international), '+52 821 123 4567');
      expect(phoneUtil.format(_mxNumber2, PhoneNumberFormat.e164), '+528211234567');
    });

    test('testFormatOutOfCountryCallingNumber', () {
      expect(phoneUtil.formatOutOfCountryCallingNumber(_usPremium, 'DE'), '00 1 900 253 0000');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_usNumber, 'BS'), '1 650 253 0000');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_usNumber, 'PL'), '00 1 650 253 0000');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_gbMobile, 'US'), '011 44 7912 345 678');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_deShortNumber, 'GB'), '00 49 1234');
      // Note this number is correctly formatted without national prefix. Most of
      // the numbers that are treated as invalid numbers by the library are short
      // numbers, and they are usually not dialed with national prefix.
      expect(phoneUtil.formatOutOfCountryCallingNumber(_deShortNumber, 'DE'), '1234');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_itNumber, 'US'), '011 39 02 3661 8300');
      expect(phoneUtil.formatOutOfCountryCallingNumber(_itNumber, 'IT'), '02 3661 8300');
      expect(phoneUtil.formatOutOfCountryCallingNumber(_itNumber, 'SG'), '+39 02 3661 8300');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_sgNumber, 'SG'), '6521 8000');

      expect(phoneUtil.formatOutOfCountryCallingNumber(_arMobile, 'US'), '011 54 9 11 8765 4321');
      expect(phoneUtil.formatOutOfCountryCallingNumber(_internationalTollFree, 'US'), '011 800 1234 5678');

      PhoneNumber arNumberWithExtn = _arMobile.deepCopy();
      arNumberWithExtn.extension_3 = '1234';
      expect(phoneUtil.formatOutOfCountryCallingNumber(arNumberWithExtn, 'US'), '011 54 9 11 8765 4321 ext. 1234');
      expect(phoneUtil.formatOutOfCountryCallingNumber(arNumberWithExtn, 'AU'), '0011 54 9 11 8765 4321 ext. 1234');
      expect(phoneUtil.formatOutOfCountryCallingNumber(arNumberWithExtn, 'AR'), '011 15 8765-4321 ext. 1234');
    });

    test('testFormatOutOfCountryWithInvalidRegion', () {
      // AQ/Antarctica isn't a valid region code for phone number formatting,
      // so this falls back to intl formatting.
      expect(phoneUtil.formatOutOfCountryCallingNumber(_usNumber, 'AQ'), '+1 650 253 0000');
      // For region code 001, the out-of-country format always turns into the
      // international format.
      expect(phoneUtil.formatOutOfCountryCallingNumber(_usNumber, '001'), '+1 650 253 0000');
    });
    ...
    test('testFormatOutOfCountryWithPreferredIntlPrefix', () {
      ...
      // test metadta.)
      expect(phoneUtil.formatOutOfCountryCallingNumber(_itNumber, 'AU'), '0011 39 02 3661 8300');

      // Testing preferred international prefixes with ~ are supported (designates
      // waiting).
      expect(phoneUtil.formatOutOfCountryCallingNumber(_itNumber, 'UZ'), '8~10 39 02 3661 8300');
    });
    ...
    test('testFormatOutOfCountryKeepingAlphaChars', () {
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'AU'), '0011 1 800 SIX-FLAG');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'US'), '1 800 SIX-FLAG');

      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'BS'), '1 800 SIX-FLAG');

      // Testing a number with extension.
      PhoneNumber alphaNumericNumberWithExtn = phoneUtil.parseAndKeepRawInput("800 SIX-flag ext. 1234", 'US');
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumberWithExtn, 'AU'),
          "0011 1 800 SIX-FLAG extn. 1234");

      // Testing that if the raw input doesn't exist, it is formatted using
      // formatOutOfCountryCallingNumber.
      alphaNumericNumber.clearRawInput();
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'DE'), '00 1 800 749 3524');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'AU'), '082749-FLAG');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'AU'), '1-800-SIX-FLAG');
      ...
      expect(phoneUtil.formatOutOfCountryCallingNumber(alphaNumericNumber, 'AU'), '1800 749 352');

      // Testing a region with multiple international prefixes.
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'SG'), '+61 1-800-SIX-FLAG');
      // Testing the case of calling from a non-supported region.
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'AQ'), '+61 1-800-SIX-FLAG');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'DE'), '1-800-SIX-flag');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'DE'), '00 1 180-SIX');
      ...
      expect(phoneUtil.formatOutOfCountryKeepingAlphaChars(alphaNumericNumber, 'AQ'), '+1 180-SIX');
    });
    ...
    test('testFormatWithCarrierCode', () {
      ...
      expect(phoneUtil.format(arMobile, PhoneNumberFormat.national), '02234 65-4321');
      // Here we force 14 as the carrier code.
      expect(phoneUtil.formatNationalNumberWithCarrierCode(arMobile, '14'), '02234 14 65-4321');
      // Here we force the number to be shown with no carrier code.
      expect(phoneUtil.formatNationalNumberWithCarrierCode(arMobile, ''), '02234 65-4321');
      // Here the international rule is used, so no carrier code should be present.
      expect(phoneUtil.format(arMobile, PhoneNumberFormat.e164), '+5492234654321');
      // We don't support this for the US so there should be no change.
      expect(phoneUtil.formatNationalNumberWithCarrierCode(_usNumber, '15'), '650 253 0000');
      // Invalid country code should just get the NSN.
      expect(phoneUtil.formatNationalNumberWithCarrierCode(_unknownCountryCodeNoRawInput, '89'), '12345');
    });
    ...
    test('testFormatWithPreferredCarrierCode', () {
      ...
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(arNumber, '15'), '01234 15 12-5678');
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(arNumber, ''), '01234 12-5678');
      // Test formatting with preferred carrier code present.
      arNumber.preferredDomesticCarrierCode = '19';
      expect(phoneUtil.format(arNumber, PhoneNumberFormat.national), '01234 12-5678');
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(arNumber, '15'), '01234 19 12-5678');
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(arNumber, ''), '01234 19 12-5678');
      ...
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(arNumber, '15'), '01234   12-5678');
      ...
      expect(phoneUtil.format(usNumber, PhoneNumberFormat.national), '424 123 1234');
      expect(phoneUtil.formatNationalNumberWithPreferredCarrierCode(usNumber, '15'), '424 123 1234');
    });
    ...
    test('testFormatNumberForMobileDialing', () {
      ...
      expect(phoneUtil.formatNumberForMobileDialing(_coFixedLine, 'CO', false), '6012345678');
      expect(phoneUtil.formatNumberForMobileDialing(_deNumber, 'DE', false), '030123456');
      expect(phoneUtil.formatNumberForMobileDialing(_deNumber, 'CH', false), '+4930123456');

      final deNumberWithExtn = _deNumber.deepCopy();
      deNumberWithExtn.extension_3 = '1234';
      expect(phoneUtil.formatNumberForMobileDialing(deNumberWithExtn, 'DE', false), '030123456');
      expect(phoneUtil.formatNumberForMobileDialing(deNumberWithExtn, 'CH', false), '+4930123456');
      ...
      expect(phoneUtil.formatNumberForMobileDialing(_usTollfree, 'US', true), '800 253 0000');
      expect(phoneUtil.formatNumberForMobileDialing(_usTollfree, 'CN', true), '');
      expect(phoneUtil.formatNumberForMobileDialing(_usNumber, 'US', true), '+1 650 253 0000');

      PhoneNumber usNumberWithExtn = _usNumber.deepCopy();
      usNumberWithExtn.extension_3 = '1234';
      expect(phoneUtil.formatNumberForMobileDialing(usNumberWithExtn, 'US', true), '+1 650 253 0000');

      expect(phoneUtil.formatNumberForMobileDialing(_usTollfree, 'US', false), '8002530000');
      expect(phoneUtil.formatNumberForMobileDialing(_usTollfree, 'CN', false), '');
      expect(phoneUtil.formatNumberForMobileDialing(_usNumber, 'US', false), '+16502530000');
      expect(phoneUtil.formatNumberForMobileDialing(usNumberWithExtn, 'US', false), '+16502530000');

      // An invalid US number, which is one digit too long.
      expect(phoneUtil.formatNumberForMobileDialing(_usLongNumber, 'US', false), '+165025300001');
      expect(phoneUtil.formatNumberForMobileDialing(_usLongNumber, 'US', true), '+1 65025300001');

      // Star numbers. In real life they appear in Israel, but we have them in JP
      // in our test metadata.
      expect(phoneUtil.formatNumberForMobileDialing(_jpStarNumber, 'JP', false), '*2345');
      expect(phoneUtil.formatNumberForMobileDialing(_jpStarNumber, 'JP', true), '*2345');

      expect(phoneUtil.formatNumberForMobileDialing(_internationalTollFree, 'JP', false), '+80012345678');
      expect(phoneUtil.formatNumberForMobileDialing(_internationalTollFree, 'JP', true), '+800 1234 5678');

      // UAE numbers beginning with 600 (classified as UAN) need to be dialled
      // without +971 locally.
      expect(phoneUtil.formatNumberForMobileDialing(_aeUan, 'JP', false), '+971600123456');
      expect(phoneUtil.formatNumberForMobileDialing(_aeUan, 'AE', false), '600123456');

      expect(phoneUtil.formatNumberForMobileDialing(_mxNumber1, 'MX', false), '+523312345678');
      expect(phoneUtil.formatNumberForMobileDialing(_mxNumber1, 'US', false), '+523312345678');

      // Test whether Uzbek phone numbers are returned in international format even
      // when dialled from same region or other regions.
      // Fixed-line number
      expect(phoneUtil.formatNumberForMobileDialing(_uzFixedLine, 'UZ', false), '+998612201234');
      // Mobile number
      expect(phoneUtil.formatNumberForMobileDialing(_uzMobile, 'UZ', false), '+998950123456');
      expect(phoneUtil.formatNumberForMobileDialing(_uzMobile, 'US', false), '+998950123456');

      // Non-geographical numbers should always be dialed in international format.
      expect(phoneUtil.formatNumberForMobileDialing(_internationalTollFree, 'US', false), '+80012345678');
      expect(phoneUtil.formatNumberForMobileDialing(_internationalTollFree, '001', false), '+80012345678');
      ...
      expect(phoneUtil.formatNumberForMobileDialing(deShortNumber, 'DE', false), '123');
      ...
      // national format.
      expect(phoneUtil.formatNumberForMobileDialing(_usNumber, 'US', false), '+16502530000');
      expect(phoneUtil.formatNumberForMobileDialing(_usNumber, 'CA', false), '+16502530000');
      expect(phoneUtil.formatNumberForMobileDialing(_usNumber, 'BR', false), '+16502530000');
      final usShortNumber = PhoneNumber()
        ..countryCode = 1
        ..nationalNumber = Int64(911);
      expect(phoneUtil.formatNumberForMobileDialing(usShortNumber, 'US', false), '911');
      ...
      final auShortNumber = PhoneNumber()
        ...
        ..italianLeadingZero = true
        ..numberOfLeadingZeros = 2;
      expect(phoneUtil.formatNumberForMobileDialing(auShortNumber, 'AU', false), '000');
    ...
    test('testFormatByPattern', () {
      ...
      expect(phoneUtil.formatByPattern(_usNumber, PhoneNumberFormat.national, [newNumFormat]), '(650) 253-0000');
      expect(
          phoneUtil.formatByPattern(_usNumber, PhoneNumberFormat.international, [newNumFormat]), '+1 (650) 253-0000');
      expect(phoneUtil.formatByPattern(_usNumber, PhoneNumberFormat.rfc3966, [newNumFormat]), 'tel:+1-650-253-0000');
      ...
      expect(phoneUtil.formatByPattern(_bsNumber, PhoneNumberFormat.national, [newNumFormat]), '1 (242) 365-1234');
      expect(phoneUtil.formatByPattern(_bsNumber, PhoneNumberFormat.international, [newNumFormat]), '+1 242 365-1234');

      newNumFormat.pattern = '(\\d{2})(\\d{5})(\\d{3})';
      newNumFormat.format = r'$1-$2 $3';
      expect(phoneUtil.formatByPattern(_itNumber, PhoneNumberFormat.national, [newNumFormat]), '02-36618 300');
      expect(phoneUtil.formatByPattern(_itNumber, PhoneNumberFormat.international, [newNumFormat]), '+39 02-36618 300');

      newNumFormat.nationalPrefixFormattingRule = r'$NP$FG';
      newNumFormat.pattern = '(\\d{2})(\\d{4})(\\d{4})';
      newNumFormat.format = r'$1 $2 $3';
      expect(phoneUtil.formatByPattern(_gbNumber, PhoneNumberFormat.national, [newNumFormat]), '020 7031 3000');

      newNumFormat.nationalPrefixFormattingRule = r'($NP$FG)';
      expect(phoneUtil.formatByPattern(_gbNumber, PhoneNumberFormat.national, [newNumFormat]), '(020) 7031 3000');

      newNumFormat.nationalPrefixFormattingRule = '';
      expect(phoneUtil.formatByPattern(_gbNumber, PhoneNumberFormat.national, [newNumFormat]), '20 7031 3000');
      expect(phoneUtil.formatByPattern(_gbNumber, PhoneNumberFormat.international, [newNumFormat]), '+44 20 7031 3000');
    });

    test('testFormatE164Number', () {
      expect(phoneUtil.format(_usNumber, PhoneNumberFormat.e164), '+16502530000');
      expect(phoneUtil.format(_deNumber, PhoneNumberFormat.e164), '+4930123456');
      expect(phoneUtil.format(_internationalTollFree, PhoneNumberFormat.e164), '+80012345678');
    });
    ...
    test('testFormatNumberWithExtension', () {
      ...
      expect(phoneUtil.format(nzNumber, PhoneNumberFormat.national), '03-331 6005 ext. 1234');
      // Uses RFC 3966 syntax.
      expect(phoneUtil.format(nzNumber, PhoneNumberFormat.rfc3966), 'tel:+64-3-331-6005;ext=1234');
      // Extension prefix overridden in the territory information for the US:
      PhoneNumber usNumberWithExtension = _usNumber.deepCopy();
      usNumberWithExtension.extension_3 = '4567';
      expect(phoneUtil.format(usNumberWithExtension, PhoneNumberFormat.national), '650 253 0000 extn. 4567');
    });

    test('testFormatInOriginalFormat', () {
      PhoneNumber number1 = phoneUtil.parseAndKeepRawInput('+442087654321', 'GB');
      expect(phoneUtil.formatInOriginalFormat(number1, 'GB'), '+44 20 8765 4321');

      PhoneNumber number2 = phoneUtil.parseAndKeepRawInput('02087654321', 'GB');
      expect(phoneUtil.formatInOriginalFormat(number2, 'GB'), '(020) 8765 4321');

      PhoneNumber number3 = phoneUtil.parseAndKeepRawInput('011442087654321', 'US');
      expect(phoneUtil.formatInOriginalFormat(number3, 'US'), '011 44 20 8765 4321');

      PhoneNumber number4 = phoneUtil.parseAndKeepRawInput('442087654321', 'GB');
      expect(phoneUtil.formatInOriginalFormat(number4, 'GB'), '44 20 8765 4321');

      PhoneNumber number5 = phoneUtil.parse('+442087654321', 'GB');
      expect(phoneUtil.formatInOriginalFormat(number5, 'GB'), '(020) 8765 4321');
      ...
      PhoneNumber number7 = phoneUtil.parseAndKeepRawInput('0734567 8901', 'US');
      ...
      PhoneNumber number8 = phoneUtil.parseAndKeepRawInput('02-4567-8900', 'KR');
      expect(phoneUtil.formatInOriginalFormat(number8, 'KR'), '02-4567-8900');

      PhoneNumber number9 = phoneUtil.parseAndKeepRawInput('01180012345678', 'US');
      expect(phoneUtil.formatInOriginalFormat(number9, 'US'), '011 800 1234 5678');

      PhoneNumber number10 = phoneUtil.parseAndKeepRawInput('+80012345678', 'KR');
      expect(phoneUtil.formatInOriginalFormat(number10, 'KR'), '+800 1234 5678');

      // US local numbers are formatted correctly, as we have formatting patterns
      // for them.
      PhoneNumber localNumberUS = phoneUtil.parseAndKeepRawInput('2530000', 'US');
      expect(phoneUtil.formatInOriginalFormat(localNumberUS, 'US'), '253 0000');

      PhoneNumber numberWithNationalPrefixUS = phoneUtil.parseAndKeepRawInput('18003456789', 'US');
      expect(phoneUtil.formatInOriginalFormat(numberWithNationalPrefixUS, 'US'), '1 800 345 6789');

      PhoneNumber numberWithoutNationalPrefixGB = phoneUtil.parseAndKeepRawInput('2087654321', 'GB');
      expect(phoneUtil.formatInOriginalFormat(numberWithoutNationalPrefixGB, 'GB'), '20 8765 4321');
      // Make sure no metadata is modified as a result of the previous function
      // call.
      expect(phoneUtil.formatInOriginalFormat(number5, 'GB'), '(020) 8765 4321');

      PhoneNumber numberWithNationalPrefixMX = phoneUtil.parseAndKeepRawInput('013312345678', 'MX');
      expect(phoneUtil.formatInOriginalFormat(numberWithNationalPrefixMX, 'MX'), '01 33 1234 5678');

      PhoneNumber numberWithoutNationalPrefixMX = phoneUtil.parseAndKeepRawInput('3312345678', 'MX');
      expect(phoneUtil.formatInOriginalFormat(numberWithoutNationalPrefixMX, 'MX'), '33 1234 5678');

      PhoneNumber italianFixedLineNumber = phoneUtil.parseAndKeepRawInput('0212345678', 'IT');
      expect(phoneUtil.formatInOriginalFormat(italianFixedLineNumber, 'IT'), '02 1234 5678');

      PhoneNumber numberWithNationalPrefixJP = phoneUtil.parseAndKeepRawInput('00777012', 'JP');
      expect(phoneUtil.formatInOriginalFormat(numberWithNationalPrefixJP, 'JP'), '0077-7012');

      PhoneNumber numberWithoutNationalPrefixJP = phoneUtil.parseAndKeepRawInput('0777012', 'JP');
      expect(phoneUtil.formatInOriginalFormat(numberWithoutNationalPrefixJP, 'JP'), '0777012');

      PhoneNumber numberWithCarrierCodeBR = phoneUtil.parseAndKeepRawInput('012 3121286979', 'BR');
      expect(phoneUtil.formatInOriginalFormat(numberWithCarrierCodeBR, 'BR'), '012 3121286979');
      ...
      PhoneNumber numberWithNationalPrefixMX1 = phoneUtil.parseAndKeepRawInput('044(33)1234-5678', 'MX');
      expect(phoneUtil.formatInOriginalFormat(numberWithNationalPrefixMX1, 'MX'), '044(33)1234-5678');

      PhoneNumber numberWithNationalPrefixMX2 = phoneUtil.parseAndKeepRawInput('045(33)1234-5678', 'MX');
      expect(phoneUtil.formatInOriginalFormat(numberWithNationalPrefixMX2, 'MX'), '045 33 1234 5678');
      ...
      PhoneNumber outOfCountryNumberFromAU1 = phoneUtil.parseAndKeepRawInput('0012 16502530000', 'AU');
      expect(phoneUtil.formatInOriginalFormat(outOfCountryNumberFromAU1, 'AU'), '0012 16502530000');

      PhoneNumber outOfCountryNumberFromAU2 = phoneUtil.parseAndKeepRawInput('0011 16502530000', 'AU');
      expect(phoneUtil.formatInOriginalFormat(outOfCountryNumberFromAU2, 'AU'), '0011 1 650 253 0000');
      ...
      PhoneNumber numberWithoutStar = phoneUtil.parseAndKeepRawInput('1234', 'JP');
      ...
      // national number.
      expect(phoneUtil.formatInOriginalFormat(_usShortByOneNumber, 'US'), '650253000');
    });
    ...
    test('testIsPremiumRate', () {
      ...
      expect(phoneUtil.getNumberType(premiumRateNumber), PhoneNumberType.premiumRate);
      ...
      expect(phoneUtil.getNumberType(premiumRateNumber), PhoneNumberType.premiumRate);
      expect(phoneUtil.getNumberType(_universalPremiumRate), PhoneNumberType.premiumRate);
    });
    ...
    test('testIsTollFree', () {
      ...
      expect(phoneUtil.getNumberType(tollFreeNumber), PhoneNumberType.tollFree);
      expect(phoneUtil.getNumberType(_internationalTollFree), PhoneNumberType.tollFree);
    });
    ...
    test('testIsFixedLineAndMobile', () {
      expect(phoneUtil.getNumberType(_usNumber), PhoneNumberType.fixedLineOrMobile);

      final fixedLineAndMobileNumber = PhoneNumber()
        ..countryCode = 54
        ..nationalNumber = Int64(1987654321);
      expect(phoneUtil.getNumberType(fixedLineAndMobileNumber), PhoneNumberType.fixedLineOrMobile);
    });
    ...
    test('testIsValidForRegion', () {
      ...
      expect(phoneUtil.isValidNumberForRegion(reNumber, 'YT'), true);
      expect(phoneUtil.isValidNumberForRegion(reNumber, 'RE'), true);
      expect(phoneUtil.isValidNumberForRegion(_internationalTollFree, '001'), true);
      expect(phoneUtil.isValidNumberForRegion(_internationalTollFree, 'US'), false);
      expect(phoneUtil.isValidNumberForRegion(_internationalTollFree, 'ZZ'), false);
    ...
    test('testIsPossibleNumberForType_DifferentTypeLengths', () {
      ...
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLine), false);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.unknown), false);

      // 6-digit numbers are okay for fixed-line.
      number.nationalNumber = Int64(123456);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.unknown), true);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLine), true);
      // But too short for mobile.
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.mobile), false);
      // And too short for toll-free.
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.tollFree), false);
      ...
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.unknown), true);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLine), true);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.mobile), true);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.tollFree), true);
    ...
    test('testIsPossibleNumberForType_NumberTypeNotSupportedForRegion', () {
      ...
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLine), true);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLineOrMobile), true);
      ...
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.mobile), false);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLine), false);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.fixedLineOrMobile), false);
      expect(phoneUtil.isPossibleNumberForType(number, PhoneNumberType.premiumRate), true);
    });

    test('testIsPossibleNumberWithReason', () {
      // National numbers for country calling code +1 that are within 7 to 10 digits
      // are possible.
      expect(phoneUtil.isPossibleNumberWithReason(_usNumber), ValidationResult.isPossible);
      expect(phoneUtil.isPossibleNumberWithReason(_usLocalNumber), ValidationResult.isPossibleLocalOnly);
      expect(phoneUtil.isPossibleNumberWithReason(_usLongNumber), ValidationResult.tooLong);

      var number = PhoneNumber()
        ..countryCode = 0
        ..nationalNumber = Int64(2530000);
      expect(phoneUtil.isPossibleNumberWithReason(number), ValidationResult.invalidCountryCode);

      number = PhoneNumber()
        ..countryCode = 1
        ..nationalNumber = Int64(253000);
      expect(ValidationResult.tooShort, phoneUtil.isPossibleNumberWithReason(number));

      number = PhoneNumber()
        ..countryCode = 65
        ..nationalNumber = Int64(1234567890);
      expect(phoneUtil.isPossibleNumberWithReason(number), ValidationResult.isPossible);
      expect(phoneUtil.isPossibleNumberWithReason(_internationalTollFreeTooLong), ValidationResult.tooLong);
    });
    ...
    test('testIsPossibleNumberForTypeWithReason_DifferentTypeLengths', () {
      ...
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.unknown), ValidationResult.tooShort);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine), ValidationResult.tooShort);

      // 6-digit numbers are okay for fixed-line.
      number.nationalNumber = Int64(123456);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.unknown), ValidationResult.isPossible);
      expect(
          phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine), ValidationResult.isPossible);
      // But too short for mobile.
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.mobile), ValidationResult.tooShort);
      // And too short for toll-free.
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.tollFree), ValidationResult.tooShort);
      ...
      expect(
          phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine), ValidationResult.isPossible);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.mobile), ValidationResult.isPossible);
      expect(
          phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.tollFree), ValidationResult.isPossible);
      ...
      number.nationalNumber = Int64(12345678901);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.unknown), ValidationResult.isPossible);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine), ValidationResult.tooLong);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.mobile), ValidationResult.isPossible);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.tollFree), ValidationResult.tooLong);
    });
    ...
    test('testIsPossibleNumberForTypeWithReason_LocalOnly', () {
      final number = PhoneNumber()
        ...
        ..nationalNumber = Int64(12);
      // Here we test a number length which matches a local-only length.
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.unknown),
          ValidationResult.isPossibleLocalOnly);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine),
          ValidationResult.isPossibleLocalOnly);
    ...
    test('testIsPossibleNumberForTypeWithReason_NumberTypeNotSupportedForRegion', () {
      final number = PhoneNumber()
        ..countryCode = 55
        ..nationalNumber = Int64(12345678);
      ...
      // INVALID_LENGTH.
      expect(
          phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.mobile), ValidationResult.invalidLength);
      // This matches a fixed-line length though.
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLineOrMobile),
          ValidationResult.isPossibleLocalOnly);
      ...
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLineOrMobile),
          ValidationResult.invalidLength);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.premiumRate),
    ...
    test('testIsPossibleNumberForTypeWithReason_FixedLineOrMobile', () {
      ...
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLine), ValidationResult.tooShort);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.mobile), ValidationResult.tooLong);
      expect(phoneUtil.isPossibleNumberForTypeWithReason(number, PhoneNumberType.fixedLineOrMobile),
          ValidationResult.invalidLength);
    ...
    test('testIsNotPossibleNumber', () {
      ...
      expect(phoneUtil.isPossibleNumberString('+800 1234 5678 9', '001'), false);
    });
    ...
    test('testMaybeStripNationalPrefix', () {
      ...
      expect(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, null), true);
      expect(
      ...
      expect(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, null), false);
      ...
      expect(
        numberToStrip.toString(),
        strippedNumber,
        reason: 'Should have had no change - after stripping, it would not have matched the national rule.',
      );
      ...
      expect(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, carrierCode), true);
      ...
      expect(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata, null), true);
      expect(numberToStrip.toString(), transformedNumber, reason: 'Should transform the 031 to a 5315.');
    });
    ...
    test('testMaybeStripInternationalPrefix', () {
      ...
      expect(
        phoneUtil.maybeStripInternationalPrefixAndNormalize(numberToStrip, internationalPrefix),
        PhoneNumber_CountryCodeSource.FROM_NUMBER_WITH_IDD,
      );
      expect(
        numberToStrip.toString(),
        strippedNumber.toString(),
        reason: 'The number supplied was not stripped of its international prefix.',
      );
      ...
      expect(
        numberToStrip.toString(),
        strippedNumber.toString(),
        reason: 'The number supplied had a 0 after the match so should not be stripped.',
      );
    ...
    test('testMaybeExtractCountryCode', () {
      ...
      try {
        ...
        expect(
          ...
          countryCallingCode,
          reason: 'Did not extract country calling code $countryCallingCode correctly.',
        );
        expect(
      ...
      try {
        ...
        expect(
          phoneUtil.maybeExtractCountryCode(phoneNumber, metadata, numberToFill, true, number),
          0,
          reason: 'Should not have extracted a country calling code - no international prefix present.',
        );
        expect(
          number.countryCodeSource,
          PhoneNumber_CountryCodeSource.FROM_DEFAULT_COUNTRY,
      ...
      try {
        ...
        // Expected.
        expect(e.errorType, ErrorType.invalidCountryCode, reason: 'Wrong error type stored in exception.');
      }
      ...
      try {
        ...
        expect(
          phoneUtil.maybeExtractCountryCode(phoneNumber, metadata, numberToFill, true, number),
          countryCallingCode,
          reason: 'Should have extracted the country calling code of the region passed in',
        );
        expect(
          number.countryCodeSource,
      ...
      try {
        ...
        expect(
          phoneUtil.maybeExtractCountryCode(phoneNumber, metadata, numberToFill, true, number),
          0,
          reason: 'Should not have extracted a country calling code - too short number both '
    ...
    test('testParseNationalNumber', () {
      ...
      expect(_nzNumber.countryCodeSource, PhoneNumber_CountryCodeSource.UNSPECIFIED);
      ...
      expect(phoneUtil.parse('tel:03-331-6005;phone-context=+64', 'NZ'), _nzNumber);
      expect(phoneUtil.parse('tel:331-6005;phone-context=+64-3', 'NZ'), _nzNumber);
      expect(phoneUtil.parse('tel:331-6005;phone-context=+64-3', 'US'), _nzNumber);
      expect(phoneUtil.parse('My number is tel:03-331-6005;phone-context=+64', 'NZ'), _nzNumber);
      // Test parsing RFC3966 format with optional user-defined parameters. The
      // parameters will appear after the context if present.
      expect(phoneUtil.parse('tel:03-331-6005;phone-context=+64;a=%A1', 'NZ'), _nzNumber);
      // Test parsing RFC3966 with an ISDN subaddress.
      expect(phoneUtil.parse('tel:03-331-6005;isub=12345;phone-context=+64', 'NZ'), _nzNumber);
      ...
      expect(phoneUtil.parse('tel:253-0000;phone-context=www.google.com', 'US'), _usLocalNumber);
      expect(phoneUtil.parse('tel:253-0000;isub=12345;phone-context=www.google.com', 'US'), _usLocalNumber);
      expect(phoneUtil.parse('tel:2530000;isub=12345;phone-context=1234.com', 'US'), _usLocalNumber);
    ...
    test('testParseMaliciousInput', () {
      ...
      try {
        ...
        expect(e.errorType, ErrorType.tooLong, reason: 'Wrong error type stored in exception.');
      }
    ...
    test('testParseWithInternationalPrefixes', () {
      ...
      expect(phoneUtil.parse('011 800 1234 5678', 'US'), _internationalTollFree);
    ...
    test('testFailedParseOnInvalidNumbers', () {
      ...
      try {
        ...
        // Expected this exception.
        expect(e.errorType, ErrorType.notANumber, reason: 'Wrong error type stored in exception.');
      }
      ...
      try {
        ...
        // Expected this exception.
        expect(e.errorType, ErrorType.tooShortNsn, reason: 'Wrong error type stored in exception.');
      }
      ...
      try {
        ...
        // Expected this exception.
        expect(e.errorType, ErrorType.tooShortAfterIdd, reason: 'Wrong error type stored in exception.');
      }
      ...
      try {
        final domainRfcPhoneContext = 'tel:555-1234;phone-context=www.google.com';
    ...
    test('testParseNumbersWithPlusWithNoRegion', () {
      ...
      // Test parsing RFC3966 format with a phone context.
      expect(phoneUtil.parse('tel:03-331-6005;phone-context=+64', 'ZZ'), _nzNumber);
      expect(phoneUtil.parse('  tel:03-331-6005;phone-context=+64', 'ZZ'), _nzNumber);
      expect(phoneUtil.parse('tel:03-331-6005;isub=12345;phone-context=+64', 'ZZ'), _nzNumber);
      ...
      expect(phoneUtil.parseAndKeepRawInput('+64 3 331 6005', 'ZZ'), nzNumberWithRawInput);
      // Null is also allowed for the region code in these cases.
      expect(phoneUtil.parseAndKeepRawInput('+64 3 331 6005', null), nzNumberWithRawInput);
    });
    ...
    test('testParseExtensions', () {
      ...
      expect(phoneUtil.parse('tel:2034567890;ext=456;phone-context=+44', 'ZZ'), ukNumber);

      // Full-width extension, 'extn' only.
      expect(phoneUtil.parse('+442034567890\uFF45\uFF58\uFF54\uFF4E456', 'GB'), ukNumber);

      // 'xtn' only.
      expect(phoneUtil.parse('+442034567890\uFF58\uFF54\uFF4E456', 'GB'), ukNumber);
      ...
      var usWithExtension = PhoneNumber()
        ...
        ..extension_3 = '7246433';
      expect(phoneUtil.parse('(800) 901-3355 x 7246433', 'US'), usWithExtension);
      expect(phoneUtil.parse('(800) 901-3355 , ext 7246433', 'US'), usWithExtension);

      expect(phoneUtil.parse('(800) 901-3355 ; 7246433', 'US'), usWithExtension);

      // To test an extension character without surrounding spaces.
      expect(phoneUtil.parse('(800) 901-3355;7246433', 'US'), usWithExtension);
      expect(phoneUtil.parse('(800) 901-3355 ,extension 7246433', 'US'), usWithExtension);
      expect(phoneUtil.parse('(800) 901-3355 ,extensi\u00F3n 7246433', 'US'), usWithExtension);

      // Repeat with the small letter o with acute accent created by combining
      // characters.
      expect(phoneUtil.parse('(800) 901-3355 ,extensio\u0301n 7246433', 'US'), usWithExtension);
      expect(phoneUtil.parse('(800) 901-3355 , 7246433', 'US'), usWithExtension);
      expect(phoneUtil.parse('(800) 901-3355 ext: 7246433', 'US'), usWithExtension);
      ...
      final ruWithExtension = PhoneNumber()
        ...
        ..extension_3 = '100';
      expect(phoneUtil.parse('8 (423) 202-25-11, доб. 100', 'RU'), ruWithExtension);
      expect(phoneUtil.parse('8 (423) 202-25-11 доб. 100', 'RU'), ruWithExtension);
      expect(phoneUtil.parse('8 (423) 202-25-11, доб 100', 'RU'), ruWithExtension);
      expect(phoneUtil.parse('8 (423) 202-25-11 доб 100', 'RU'), ruWithExtension);
      ...
      final usWithTwoExtensionsNumber = PhoneNumber()
        ...
        ..extension_3 = '508';
      expect(phoneUtil.parse('(212)123-1234 x508/x1234', 'US'), usWithTwoExtensionsNumber);
      expect(phoneUtil.parse('(212)123-1234 x508/ x1234', 'US'), usWithTwoExtensionsNumber);
      expect(phoneUtil.parse('(212)123-1234 x508\\x1234', 'US'), usWithTwoExtensionsNumber);
      ...
      expect(phoneUtil.parse('+1 (645) 123 1234 ext. 910#', 'US'), usWithExtension);
    });
    ...
    test('testParseHandlesLongExtensionsWithExplicitLabels', () {
      ...
      expect(phoneUtil.parse('tel:+6433316005;ext=01234567890123456789', 'NZ'), nzNumber);

      // Extension too long.
      try {
        phoneUtil.parse('tel:+6433316005;ext=012345678901234567890', 'NZ');
        fail('This should not parse as length of extension is higher than allowed: '
      ...
      expect(phoneUtil.parse('03 3316005 xtn:12345678901234567890', 'NZ'), nzNumber);
      expect(phoneUtil.parse('03 3316005 extension\t12345678901234567890', 'NZ'), nzNumber);
      expect(phoneUtil.parse('03 3316005 xtensio:12345678901234567890', 'NZ'), nzNumber);
      expect(phoneUtil.parse('03 3316005 xtensión, 12345678901234567890#', 'NZ'), nzNumber);
      expect(phoneUtil.parse('03 3316005extension.12345678901234567890', 'NZ'), nzNumber);
      expect(phoneUtil.parse('03 3316005 доб:12345678901234567890', 'NZ'), nzNumber);
    ...
    test('testParseHandlesLongExtensionsWithAutoDiallingLabels', () {
      ...
      expect(phoneUtil.parse('+12679000000,,123456789012345#', 'US'), usNumberUserInput);
      expect(phoneUtil.parse('+12679000000;123456789012345#', 'US'), usNumberUserInput);
      ...
      expect(phoneUtil.parse('+442034000000,,123456789#', 'GB'), ukNumberUserInput);
    ...
    test('testParseHandlesShortExtensionsWithAmbiguousChar', () {
      ...
      try {
        ...
        fail('This should not parse as length of extension is higher than allowed: 03 3316005 ~ 1234567890');
      } on NumberParseException catch (e) {
        // Expected this exception.
        expect(e.errorType, ErrorType.tooLong, reason: 'Wrong error type stored in exception.');
      }
    ...
    test('testParseHandlesShortExtensionsWhenNotSureOfLabel', () {
      ...
      try {
        ...
        fail('This should not parse as length of extension is higher than allowed: +1123-456-7890 7777777#');
      } on NumberParseException catch (e) {
        // Expected this exception.
        expect(e.errorType, ErrorType.notANumber, reason: 'Wrong error type stored in exception.');
      }
    ...
    test('testParseAndKeepRaw', () {
      ...
      expect(phoneUtil.parseAndKeepRawInput('800 six-flags', 'US'), alphaNumericNumber);
      ...
      expect(phoneUtil.parseAndKeepRawInput('1800 six-flag', 'US'), shorterAlphaNumber);

      shorterAlphaNumber
        ..rawInput = '+1800 six-flag'
        ..countryCodeSource = PhoneNumber_CountryCodeSource.FROM_NUMBER_WITH_PLUS_SIGN;
      expect(phoneUtil.parseAndKeepRawInput('+1800 six-flag', 'NZ'), shorterAlphaNumber);

      alphaNumericNumber
        ..countryCode = 1
        ..nationalNumber = Int64(8007493524)
        ..rawInput = '001800 six-flag'
        ..countryCodeSource = PhoneNumber_CountryCodeSource.FROM_NUMBER_WITH_IDD;
      expect(phoneUtil.parseAndKeepRawInput('001800 six-flag', 'NZ'), alphaNumericNumber);
    ...
    test('testParseWithPhoneContext', () {
      ...
      expect(phoneUtil.parse("tel:033316005;phone-context=+64", 'ZZ'), _nzNumber);
      expect(phoneUtil.parse("tel:033316005;phone-context=+64;{this isn't part of phone-context anymore!}", 'ZZ'),
          _nzNumber);

      final nzFromPhoneContext = PhoneNumber()
        ..countryCode = 64
        ..nationalNumber = Int64(3033316005);
      expect(phoneUtil.parse("tel:033316005;phone-context=+64-3", 'ZZ'), nzFromPhoneContext);

      final brFromPhoneContext = PhoneNumber()
        ..countryCode = 55
        ..nationalNumber = Int64(5033316005);
      expect(phoneUtil.parse("tel:033316005;phone-context=+(555)", 'ZZ'), brFromPhoneContext);

      final usFromPhoneContext = PhoneNumber()
        ..countryCode = 1
        ..nationalNumber = Int64(23033316005);
      expect(phoneUtil.parse("tel:033316005;phone-context=+-1-2.3()", 'ZZ'), usFromPhoneContext);

      // Valid domainname
      expect(phoneUtil.parse("tel:033316005;phone-context=abc.nz", 'NZ'), _nzNumber);
      expect(phoneUtil.parse("tel:033316005;phone-context=www.PHONE-numb3r.com", 'NZ'), _nzNumber);
      expect(phoneUtil.parse("tel:033316005;phone-context=a", 'NZ'), _nzNumber);
      expect(phoneUtil.parse("tel:033316005;phone-context=3phone.J.", 'NZ'), _nzNumber);
    ...
    test('testCountryWithNoNumberDesc', () {
      ...
      final adNumber = PhoneNumber()
        ..countryCode = 376
        ..nationalNumber = Int64(12345);
      expect('+376 12345', phoneUtil.format(adNumber, PhoneNumberFormat.international));
      ...
      expect('00 1 650 253 0000', phoneUtil.formatOutOfCountryCallingNumber(_usNumber, 'AD'));
    });
    ...
    test('testUnknownCountryCallingCode', () {
      ...
      expect(phoneUtil.format(_unknownCountryCodeNoRawInput, PhoneNumberFormat.e164), '+212345');
    });
    ...
    test('testIsNumberMatchMatches', () {
      ...
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 3 331 6005', '+64 03 331 6005'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+800 1234 5678', '+80012345678'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 03 331-6005', '+64 03331 6005'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+643 331-6005', '+64033316005'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+643 331-6005', '+6433316005'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 3 331-6005', '+6433316005'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 3 331-6005', 'tel:+64-3-331-6005;isub=123'));
      // Test alpha numbers.
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+1800 siX-Flags', '+1 800 7493 5247'));
      // Test numbers with extensions.
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 3 331-6005 extn 1234', '+6433316005#1234'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+64 3 331-6005 ext. 1234', '+6433316005;1234'));
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch('+7 423 202-25-11 ext 100', '+7 4232022511 доб. 100'));
      // Test proto buffers.
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch(_nzNumber, '+6403 331 6005'));

      PhoneNumber nzNumber = _nzNumber.deepCopy();
      nzNumber.extension_3 = '3456';
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch(nzNumber, '+643 331 6005 ext 3456'));
      // Check empty extensions are ignored.
      nzNumber.extension_3 = '';
      expect(MatchType.exactMatch, phoneUtil.isNumberMatch(nzNumber, '+6403 331 6005'));
      // Check variant with two proto buffers.
      expect(phoneUtil.isNumberMatch(nzNumber, _nzNumber), MatchType.exactMatch, reason: 'Numbers did not match');
    });
    ...
    test('testIsNumberMatchShortMatchIfDiffNumLeadingZeros', () {
      ...
      expect(MatchType.shortNsnMatch, phoneUtil.isNumberMatch(nzNumberOne, nzNumberTwo));
    ...
    test('testIsNumberMatchAcceptsProtoDefaultsAsMatch', () {
      ...
      expect(phoneUtil.isNumberMatch(nzNumberOne, nzNumberTwo), MatchType.exactMatch);
    });
    ...
    test('testIsNumberMatchIgnoresSomeFields', () {
      ...
      expect(phoneUtil.isNumberMatch(brNumberOne, brNumberTwo), MatchType.exactMatch);
    });

    test('testIsNumberMatchNonMatches', () {
      // Non-matches.
      expect(phoneUtil.isNumberMatch('03 331 6005', '03 331 6006'), MatchType.noMatch);
      expect(phoneUtil.isNumberMatch('+800 1234 5678', '+1 800 1234 5678'), MatchType.noMatch);
      // Different country calling code, partial number match.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', '+16433316005'), MatchType.noMatch);
      // Different country calling code, same number.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', '+6133316005'), MatchType.noMatch);
      // Extension different, all else the same.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005 extn 1234', '0116433316005#1235'), MatchType.noMatch);
      expect(phoneUtil.isNumberMatch('+64 3 331-6005 extn 1234', 'tel:+64-3-331-6005;ext=1235'), MatchType.noMatch);
      // NSN matches, but extension is different - not the same number.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005 ext.1235', '3 331 6005#1234'), MatchType.noMatch);

      // Invalid numbers that can't be parsed.
      expect(phoneUtil.isNumberMatch('4', '3 331 6043'), MatchType.notANumber);
      expect(phoneUtil.isNumberMatch('+43', '+64 3 331 6005'), MatchType.notANumber);
      expect(phoneUtil.isNumberMatch('+43', '64 3 331 6005'), MatchType.notANumber);
      expect(phoneUtil.isNumberMatch('Dog', '64 3 331 6005'), MatchType.notANumber);
    });

    test('testIsNumberMatchNsnMatches', () {
      // NSN matches.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', '03 331 6005'), MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', 'tel:03-331-6005;isub=1234;phone-context=abc.nz'),
          MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch(_nzNumber, '03 331 6005'), MatchType.nsnMatch);
      ...
      expect(phoneUtil.isNumberMatch(unchangedNzNumber, '(64-3) 331 6005'), MatchType.nsnMatch);
      ...
      expect(phoneUtil.isNumberMatch(_usNumber, '1-650-253-0000'), MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch(_usNumber, '6502530000'), MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch('+1 650-253 0000', '1 650 253 0000'), MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch('1 650-253 0000', '1 650 253 0000'), MatchType.nsnMatch);
      expect(phoneUtil.isNumberMatch('1 650-253 0000', '+1 650 253 0000'), MatchType.nsnMatch);
      ...
      final randomNumber = PhoneNumber()
        ..countryCode = 41
        ..nationalNumber = Int64(6502530000);
      expect(phoneUtil.isNumberMatch(randomNumber, '1-650-253-0000'), MatchType.shortNsnMatch);
    });

    test('testIsNumberMatchShortNsnMatches', () {
      // Short NSN matches with the country not specified for either one or both
      // numbers.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', '331 6005'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', 'tel:331-6005;phone-context=abc.nz'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', 'tel:331-6005;isub=1234;phone-context=abc.nz'),
          MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', 'tel:331-6005;isub=1234;phone-context=abc.nz;a=%A1'),
          MatchType.shortNsnMatch);
      ...
      expect(phoneUtil.isNumberMatch('3 331-6005', '03 331 6005'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('3 331-6005', '331 6005'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('3 331-6005', 'tel:331-6005;phone-context=abc.nz'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('3 331-6005', '+64 331 6005'), MatchType.shortNsnMatch);
      // Short NSN match with the country specified.
      expect(phoneUtil.isNumberMatch('03 331-6005', '331 6005'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('1 234 345 6789', '345 6789'), MatchType.shortNsnMatch);
      expect(phoneUtil.isNumberMatch('+1 (234) 345 6789', '345 6789'), MatchType.shortNsnMatch);
      // NSN matches, country calling code omitted for one number, extension missing
      // for one.
      expect(phoneUtil.isNumberMatch('+64 3 331-6005', '3 331 6005#1234'), MatchType.shortNsnMatch);
      ...
      final italianNumberTwo = PhoneNumber()
        ..countryCode = 39
        ..nationalNumber = Int64(1234);
      expect(phoneUtil.isNumberMatch(italianNumberOne, italianNumberTwo), MatchType.shortNsnMatch);
    ...
    test('testCanBeInternationallyDialled', () {
      ...
      expect(phoneUtil.canBeInternationallyDialled(_internationalTollFree), true);
    });
