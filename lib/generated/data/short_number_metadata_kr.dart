...
Map<String, Object?> get shortNumberMetadataKR {
  return {
    "id": "KR",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "1\\d{2,4}",
    ...
    "toll_free": {
      "national_number_pattern": "1(?:1[27-9]|28|330|82)",
      "possible_length": [3, 4],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    ...
    "carrier_specific": {
      "national_number_pattern": "1(?:0[01]|1[4-6]|41)|1(?:[06-9]1\\d|111)\\d",
      "possible_length": [3, 5],
      "possible_length_local_only": [-1],
      "example_number": "100"
    },
