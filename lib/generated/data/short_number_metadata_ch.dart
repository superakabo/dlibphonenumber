...
Map<String, Object?> get shortNumberMetadataCH {
  return {
    "id": "CH",
    "country_code": 0,
    ...
    "toll_free": {
      "national_number_pattern": "1(?:1(?:[278]|6\\d{3})|4[47])|5200",
      "possible_length": [3, 4, 6],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    "premium_rate": {
      "national_number_pattern": "1(?:14|8[0-2589])\\d|543|83111",
    ...
    "emergency": {
      "national_number_pattern": "1(?:1[278]|44)",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    ...
    "standard_rate": {
      "national_number_pattern": "1(?:4[035]|6[1-46])|1(?:41|60)\\d",
      "possible_length": [3, 4],
      "possible_length_local_only": [-1],
      "example_number": "140"
    },
    "carrier_specific": {
      "national_number_pattern": "5(?:200|35)",
      "possible_length": [3, 4],
      "possible_length_local_only": [-1],
      "example_number": "535"
    },
    "sms_services": {
      "national_number_pattern": "[2-9]\\d{2,4}",
      "possible_length": [3, 4, 5],
      "possible_length_local_only": [-1],
      "example_number": "200"
    },
