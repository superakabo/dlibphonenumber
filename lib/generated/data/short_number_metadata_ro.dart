...
Map<String, Object?> get shortNumberMetadataRO {
  return {
    "id": "RO",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[18]\\d{2,5}",
    ...
    "toll_free": {
      "national_number_pattern": "11(?:2|6\\d{3})",
      "possible_length": [3, 6],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    "premium_rate": {
      "national_number_pattern": "(?:1(?:18[39]|[24])|8[48])\\d\\d",
      "possible_length": [4, 6],
      "possible_length_local_only": [-1],
      "example_number": "1200"
    },
    ...
    "sms_services": {
      "national_number_pattern": "(?:1[24]|8[48])\\d\\d",
      "possible_length": [4],
      "possible_length_local_only": [-1],
      "example_number": "1200"
    },
