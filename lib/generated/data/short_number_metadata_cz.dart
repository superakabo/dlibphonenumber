...
Map<String, Object?> get shortNumberMetadataCZ {
  return {
    "id": "CZ",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "1\\d{2,5}",
    ...
    "toll_free": {
      "national_number_pattern": "1(?:1(?:2|6(?:00[06]|1(?:11|23)))|5\\d)",
      "possible_length": [3, 6],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    ...
    "emergency": {
      "national_number_pattern": "1(?:12|5\\d)",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
