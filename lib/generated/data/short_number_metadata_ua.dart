...
Map<String, Object?> get shortNumberMetadataUA {
  return {
    "id": "UA",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[189]\\d{2,5}",
    ...
    "toll_free": {
      "national_number_pattern": "1(?:0[1-3]|1(?:2|6\\d{3}))",
      "possible_length": [3, 6],
      "possible_length_local_only": [-1],
      "example_number": "101"
    },
    ...
    "carrier_specific": {
      "national_number_pattern": "(?:118|[89]00)\\d\\d?",
      "possible_length": [4, 5],
      "possible_length_local_only": [-1],
      "example_number": "1180"
    },
