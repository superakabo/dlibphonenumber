...
Map<String, Object?> get shortNumberMetadataBD {
  return {
    "id": "BD",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[1579]\\d{2,4}",
    ...
    "toll_free": {
      "national_number_pattern": "10[0-26]|[19]99",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "100"
    },
    ...
    "emergency": {
      "national_number_pattern": "10[0-2]|[19]99",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "100"
    },
    ...
    "carrier_specific": {
      "national_number_pattern": "1(?:11|2[13])|(?:501|959)\\d|786",
      "possible_length": [3, 4],
      "possible_length_local_only": [-1],
      "example_number": "111"
    },
    "sms_services": {
      "national_number_pattern": "959\\d",
      "possible_length": [4],
      "possible_length_local_only": [-1],
      "example_number": "9590"
    },
