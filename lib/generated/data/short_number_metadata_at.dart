...
Map<String, Object?> get shortNumberMetadataAT {
  return {
    "id": "AT",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[168]\\d\\d(?:\\d(?:\\d{2})?)?",
    ...
    "emergency": {
      "national_number_pattern": "1(?:[12]2|33|44)",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    ...
    "carrier_specific": {
      "national_number_pattern": "610|810\\d{3}",
      "possible_length": [3, 6],
      "possible_length_local_only": [-1],
      "example_number": "610"
    },
