...
Map<String, Object?> get shortNumberMetadataHK {
  return {
    "id": "HK",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[19]\\d{2,6}",
    ...
    "toll_free": {
      "national_number_pattern": "112|99[29]",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "112"
    },
    ...
    "carrier_specific": {
      "national_number_pattern": "109|1(?:08|85\\d)\\d",
      "possible_length": [3, 4, 5],
      "possible_length_local_only": [-1],
      "example_number": "109"
    },
    "sms_services": {
      "national_number_pattern": "992",
      "possible_length": [3],
      "possible_length_local_only": [-1],
      "example_number": "992"
    },
