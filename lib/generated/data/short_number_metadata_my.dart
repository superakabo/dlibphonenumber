...
Map<String, Object?> get shortNumberMetadataMY {
  return {
    "id": "MY",
    "country_code": 0,
    ...
    "general_desc": {
      "national_number_pattern": "[1369]\\d{2,4}",
    ...
    "standard_rate": {
      "national_number_pattern": "666\\d\\d",
      "possible_length": [5],
      "possible_length_local_only": [-1],
      "example_number": "66600"
    },
    "carrier_specific": {
      "national_number_pattern": null,
      "possible_length": [-1],
    ...
    "sms_services": {
      "national_number_pattern": "(?:3[23679]\\d|666)\\d\\d",
      "possible_length": [5],
      "possible_length_local_only": [-1],
      "example_number": "32000"
    },
