...
Map<String, List<Object>> get phoneNumberMetadataIT {
  return {
    "metadata": [
      {
        "id": "IT",
        ...
        "general_desc": {
          "national_number_pattern": "[0389]\\d{5,10}",
          "possible_length": [10, 11, 9, 6],
          "possible_length_local_only": [],
          "example_number": null
        },
        "fixed_line": {
          "national_number_pattern": "0\\d{9,10}",
          "possible_length": [10, 11],
          "possible_length_local_only": [-1],
          "example_number": "0123456789"
        },
        "mobile": {
          "national_number_pattern": "3\\d{8,9}",
          "possible_length": [9, 10],
          "possible_length_local_only": [-1],
          "example_number": "3123456789"
        },
        "toll_free": {
          "national_number_pattern": "80(?:0\\d{6}|3\\d{3})",
          "possible_length": [6, 9],
          "possible_length_local_only": [-1],
          "example_number": "800123456"
        },
        "premium_rate": {
          "national_number_pattern": "89(?:2\\d{3}|9\\d{6})",
          "possible_length": [6, 9],
          "possible_length_local_only": [-1],
          "example_number": "892123"
        },
        "shared_cost": {
        ...
        "number_format": [
          ...
          },
          {
            ...
            "format": "\$1 \$2 \$3",
            "leading_digits_pattern": ["0[13-57-9]"],
            "national_prefix_optional_when_formatting": false,
            "national_prefix_formatting_rule": null,
            "domestic_carrier_code_formatting_rule": null
          },
