    ...
    "metadata": [
      {
        ...
        "general_desc": {
          "national_number_pattern": "[268]\\d{8}",
          "possible_length": [9],
          "possible_length_local_only": [],
          "example_number": null
        },
        "fixed_line": {
          "national_number_pattern": "262\\d{6}",
          "possible_length": [9],
          "possible_length_local_only": [-1],
          "example_number": "262161234"
        },
        "mobile": {
          "national_number_pattern": "6(?:9[23]|47)\\d{6}",
          "possible_length": [9],
          "possible_length_local_only": [-1],
        ...
        "premium_rate": {
          "national_number_pattern": "8(?:1[01]|2[0156]|84|9[0-37-9])\\d{6}",
          "possible_length": [9],
          "possible_length_local_only": [-1],
