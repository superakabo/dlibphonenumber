...
class NumberFormat extends $pb.GeneratedMessage {
  factory NumberFormat({
    ...
    if (domesticCarrierCodeFormattingRule != null) {
      $result.domesticCarrierCodeFormattingRule = domesticCarrierCodeFormattingRule;
    }
    if (nationalPrefixOptionalWhenFormatting != null) {
      $result.nationalPrefixOptionalWhenFormatting = nationalPrefixOptionalWhenFormatting;
    }
    return $result;
  }
  NumberFormat._() : super();
  factory NumberFormat.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NumberFormat.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NumberFormat', package: const $pb.PackageName(_omitMessageNames ? '' : 'i18n.phonenumbers'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NumberFormat copyWith(void Function(NumberFormat) updates) => super.copyWith((message) => updates(message as NumberFormat)) as NumberFormat;
  ...
  @$pb.TagNumber(4)
  set nationalPrefixFormattingRule($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set domesticCarrierCodeFormattingRule($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set nationalPrefixOptionalWhenFormatting($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
...
class PhoneNumberDesc extends $pb.GeneratedMessage {
  ...
  factory PhoneNumberDesc.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PhoneNumberDesc.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhoneNumberDesc', package: const $pb.PackageName(_omitMessageNames ? '' : 'i18n.phonenumbers'), createEmptyInstance: create)
    ..aOS(2, _omitFieldNames ? '' : 'nationalNumberPattern')
    ..aOS(6, _omitFieldNames ? '' : 'exampleNumber')
    ..p<$core.int>(9, _omitFieldNames ? '' : 'possibleLength', $pb.PbFieldType.P3)
    ..p<$core.int>(10, _omitFieldNames ? '' : 'possibleLengthLocalOnly', $pb.PbFieldType.P3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PhoneNumberDesc copyWith(void Function(PhoneNumberDesc) updates) => super.copyWith((message) => updates(message as PhoneNumberDesc)) as PhoneNumberDesc;
  ...
  @$core.pragma('dart2js:noInline')
  static PhoneNumberDesc getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PhoneNumberDesc>(create);
  ...
  @$pb.TagNumber(2)
  set nationalNumberPattern($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set exampleNumber($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(6)
...
class PhoneMetadata extends $pb.GeneratedMessage {
  ...
  factory PhoneMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PhoneMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhoneMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'i18n.phonenumbers'), createEmptyInstance: create)
    ..aOM<PhoneNumberDesc>(1, _omitFieldNames ? '' : 'generalDesc', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(2, _omitFieldNames ? '' : 'fixedLine', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(3, _omitFieldNames ? '' : 'mobile', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(4, _omitFieldNames ? '' : 'tollFree', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(5, _omitFieldNames ? '' : 'premiumRate', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(6, _omitFieldNames ? '' : 'sharedCost', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(7, _omitFieldNames ? '' : 'personalNumber', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(8, _omitFieldNames ? '' : 'voip', subBuilder: PhoneNumberDesc.create)
    ...
    ..pc<NumberFormat>(19, _omitFieldNames ? '' : 'numberFormat', $pb.PbFieldType.PM, subBuilder: NumberFormat.create)
    ..pc<NumberFormat>(20, _omitFieldNames ? '' : 'intlNumberFormat', $pb.PbFieldType.PM, subBuilder: NumberFormat.create)
    ..aOM<PhoneNumberDesc>(21, _omitFieldNames ? '' : 'pager', subBuilder: PhoneNumberDesc.create)
    ..aOB(22, _omitFieldNames ? '' : 'mainCountryForCode')
    ..aOS(23, _omitFieldNames ? '' : 'leadingDigits')
    ..aOM<PhoneNumberDesc>(24, _omitFieldNames ? '' : 'noInternationalDialling', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(25, _omitFieldNames ? '' : 'uan', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(27, _omitFieldNames ? '' : 'emergency', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(28, _omitFieldNames ? '' : 'voicemail', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(29, _omitFieldNames ? '' : 'shortCode', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(30, _omitFieldNames ? '' : 'standardRate', subBuilder: PhoneNumberDesc.create)
    ..aOM<PhoneNumberDesc>(31, _omitFieldNames ? '' : 'carrierSpecific', subBuilder: PhoneNumberDesc.create)
    ..aOB(32, _omitFieldNames ? '' : 'mobileNumberPortableRegion')
    ..aOM<PhoneNumberDesc>(33, _omitFieldNames ? '' : 'smsServices', subBuilder: PhoneNumberDesc.create)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PhoneMetadata copyWith(void Function(PhoneMetadata) updates) => super.copyWith((message) => updates(message as PhoneMetadata)) as PhoneMetadata;
  ...
  @$pb.TagNumber(1)
  set generalDesc(PhoneNumberDesc v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set fixedLine(PhoneNumberDesc v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set mobile(PhoneNumberDesc v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set tollFree(PhoneNumberDesc v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set premiumRate(PhoneNumberDesc v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set sharedCost(PhoneNumberDesc v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set personalNumber(PhoneNumberDesc v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set voip(PhoneNumberDesc v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set countryCode($core.int v) { $_setSignedInt32(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set internationalPrefix($core.String v) { $_setString(10, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set nationalPrefix($core.String v) { $_setString(11, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set preferredExtnPrefix($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set nationalPrefixForParsing($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set nationalPrefixTransformRule($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set preferredInternationalPrefix($core.String v) { $_setString(15, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set sameMobileAndFixedLinePattern($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(21)
  set pager(PhoneNumberDesc v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set mainCountryForCode($core.bool v) { $_setBool(20, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set leadingDigits($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(24)
  set noInternationalDialling(PhoneNumberDesc v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set uan(PhoneNumberDesc v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(27)
  set emergency(PhoneNumberDesc v) { setField(27, v); }
  @$pb.TagNumber(27)
  ...
  @$pb.TagNumber(28)
  set voicemail(PhoneNumberDesc v) { setField(28, v); }
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(29)
  set shortCode(PhoneNumberDesc v) { setField(29, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(30)
  set standardRate(PhoneNumberDesc v) { setField(30, v); }
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(31)
  set carrierSpecific(PhoneNumberDesc v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(32)
  set mobileNumberPortableRegion($core.bool v) { $_setBool(29, v); }
  @$pb.TagNumber(32)
  ...
  @$pb.TagNumber(33)
  set smsServices(PhoneNumberDesc v) { setField(33, v); }
  @$pb.TagNumber(33)
...
class PhoneMetadataCollection extends $pb.GeneratedMessage {
  ...
  factory PhoneMetadataCollection.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PhoneMetadataCollection.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhoneMetadataCollection', package: const $pb.PackageName(_omitMessageNames ? '' : 'i18n.phonenumbers'), createEmptyInstance: create)
    ..pc<PhoneMetadata>(1, _omitFieldNames ? '' : 'metadata', $pb.PbFieldType.PM, subBuilder: PhoneMetadata.create)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PhoneMetadataCollection copyWith(void Function(PhoneMetadataCollection) updates) => super.copyWith((message) => updates(message as PhoneMetadataCollection)) as PhoneMetadataCollection;
  ...
  @$core.pragma('dart2js:noInline')
  static PhoneMetadataCollection getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PhoneMetadataCollection>(create);
