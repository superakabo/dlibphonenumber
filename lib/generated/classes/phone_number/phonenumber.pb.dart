...
class PhoneNumber extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhoneNumber', package: const $pb.PackageName(_omitMessageNames ? '' : 'i18n.phonenumbers'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'countryCode', $pb.PbFieldType.Q3)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'nationalNumber', $pb.PbFieldType.QU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(3, _omitFieldNames ? '' : 'extension')
    ..aOB(4, _omitFieldNames ? '' : 'italianLeadingZero')
    ..aOS(5, _omitFieldNames ? '' : 'rawInput')
    ..e<PhoneNumber_CountryCodeSource>(6, _omitFieldNames ? '' : 'countryCodeSource', $pb.PbFieldType.OE, defaultOrMaker: PhoneNumber_CountryCodeSource.UNSPECIFIED, valueOf: PhoneNumber_CountryCodeSource.valueOf, enumValues: PhoneNumber_CountryCodeSource.values)
    ..aOS(7, _omitFieldNames ? '' : 'preferredDomesticCarrierCode')
    ..a<$core.int>(8, _omitFieldNames ? '' : 'numberOfLeadingZeros', $pb.PbFieldType.O3, defaultOrMaker: 1)
  ;
