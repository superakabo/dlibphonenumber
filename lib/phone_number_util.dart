...
class PhoneNumberUtil {
  ...
  static final RegExp _validStartCharPattern = RegExp('[$_plusChars$_validDigits]');
  ...
  String _formatNsnUsingPattern(String nationalNumber, NumberFormat formattingPattern, PhoneNumberFormat numberFormat,
    ...
    if (numberFormat == PhoneNumberFormat.rfc3966) {
      ...
      if (separatorPattern.firstMatch(formattedNationalNumber)?.start == 0) {
        formattedNationalNumber = _replaceAllAndFormat(formattedNationalNumber, separatorPattern, '');
      }
      // Replace the rest with a dash between each number group.
      formattedNationalNumber = _replaceAllAndFormat(formattedNationalNumber, RegExp(_separatorPattern), '-');
    }
  ...
  bool maybeStripNationalPrefixAndCarrierCode(
    ...
    if (prefixMatcher != null && prefixMatcher.start == 0) {
      ...
      if (transformRule.isEmpty || prefixMatcher.group(numOfGroups) == null) {
        ...
        String replacedFirstNumber = _replaceFirstAndFormat(number.toString(), prefixMatcher.pattern, transformRule);
