...
[PhoneNumberUtil](https://github.com/superakabo/dlibphonenumber/blob/main/lib/phone_number_util.dart#L3060)
for details. Also see `Iterable<PhoneNumberMatch> findNumbers(String,
String)`.
...
[`resources/PhoneNumberMetadata.xml`](https://github.com/superakabo/dlibphonenumber/blob/main/resources/PhoneNumberMetadata.xml).
...
the Dart header files. For example, see `isPossibleNumberWithReason` in
[`PhoneNumberUtil`](https://github.com/superakabo/dlibphonenumber/blob/main/lib/phone_number_util.dart).
...
[`ShortNumberInfo`](https://github.com/superakabo/dlibphonenumber/blob/main/lib/short_number_info.dart).
...
The ability to keep your mobile phone number when changing carriers. To see whether a region supports mobile number portability use [isMobileNumberPortableRegion](https://github.com/superakabo/dlibphonenumber/blob/main/lib/phone_number_util.dart#L3590).
